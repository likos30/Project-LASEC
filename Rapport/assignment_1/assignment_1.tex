...
${}$\hspace{1em}We get the same thing for $\#(seg in plain) = len(plain text) - n +1$, with n the segment size.\\
...
We use R\'enyi entropy to get the good matching and all matching as it finds the collision, with the following formula:\\
